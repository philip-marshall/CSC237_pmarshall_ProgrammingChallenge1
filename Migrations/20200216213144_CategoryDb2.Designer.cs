...
namespace CSC237_pmarshall_ProgrammingChallenge1.Migrations
{
    ...
    [Migration("20200216213144_CategoryDb2")]
            ...
            modelBuilder.Entity("CSC237_pmarshall_ProgrammingChallenge1.Models.Contact", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ContactId = 1,
                            CategoryId = 3,
                            DateAdded = new DateTime(2020, 2, 16, 14, 31, 44, 285, DateTimeKind.Local).AddTicks(2794),
                        ...
                        new
                        {
                            ContactId = 2,
                            CategoryId = 3,
                            DateAdded = new DateTime(2020, 2, 16, 14, 31, 44, 288, DateTimeKind.Local).AddTicks(5381),
                        ...
                        new
                        {
                            ContactId = 3,
                            CategoryId = 1,
                            DateAdded = new DateTime(2020, 2, 16, 14, 31, 44, 288, DateTimeKind.Local).AddTicks(5441),
