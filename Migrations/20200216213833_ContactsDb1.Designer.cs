...
namespace CSC237_pmarshall_ProgrammingChallenge1.Migrations
{
    ...
    [Migration("20200216213833_ContactsDb1")]
    partial class ContactsDb1
    {
            ...
            modelBuilder.Entity("CSC237_pmarshall_ProgrammingChallenge1.Models.Contact", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ContactId = 1,
                            CategoryId = 3,
                            DateAdded = new DateTime(2020, 2, 16, 14, 38, 33, 146, DateTimeKind.Local).AddTicks(2480),
                        ...
                        new
                        {
                            ContactId = 2,
                            CategoryId = 3,
                            DateAdded = new DateTime(2020, 2, 16, 14, 38, 33, 148, DateTimeKind.Local).AddTicks(6355),
                        ...
                        new
                        {
                            ContactId = 3,
                            CategoryId = 1,
                            DateAdded = new DateTime(2020, 2, 16, 14, 38, 33, 148, DateTimeKind.Local).AddTicks(6416),
